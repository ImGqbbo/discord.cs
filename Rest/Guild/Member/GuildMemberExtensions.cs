...
namespace Discord
{
    public static class GuildMemberExtensions
    {
        ...
        {
            await client.HttpClient.PatchAsync(string.Format("https://discord.com/api/v9/guilds/{0}/members/{1}", guildId, memberId), "{\"communication_disabled_until\":null}");
        }
        ...
        public static async Task BanUserAsync(this DiscordClient client, ulong guildId, ulong userId, string reason = null, uint deleteMessagesDays = 0)
        {
            ...
            await httpClient.PutAsync(string.Format("https://discord.com/api/v9/guilds/{0}/bans/{1}", guildId, userId), new StringContent(JsonConvert.SerializeObject(new
            {
        ...
        {
            await client.HttpClient.DeleteAsync(string.Format("https://discord.com/api/v9/guilds/{0}/members/{1}", guildId, memberId));
        }
        ...
        {
            return JsonConvert.DeserializeObject<GuildBan>((await client.HttpClient.GetAsync(string.Format("https://discord.com/api/v9/guilds/{0}/bans/{1}", guildId, userId))).Result);
        }
        ...
        {
            await client.HttpClient.DeleteAsync(string.Format("https://discord.com/api/v9/guilds/{0}/bans/{1}", guildId, userId));
        }
        ...
        public static async Task<IReadOnlyList<GuildBan>> GetGuildBansAsync(this DiscordClient client, ulong guildId, uint limit = 1000)
        {
            ...
            return JsonConvert.DeserializeObject<IReadOnlyList<GuildBan>>((await client.HttpClient.GetAsync(string.Format("https://discord.com/api/v9/guilds/{0}/bans?limit={1}", guildId, limit))).Result);
        }
