...
namespace Discord
{
    public static class MessageExtensions
    {
        ...
        {
            await client.HttpClient.PostAsync(string.Format("/channels/{0}/messages", channelId), JsonConvert.SerializeObject(new
            {
                content = message,
                tts = tts
            }));
        ...
        {
            await client.HttpClient.PostAsync(string.Format("/channels/{0}/messages", channelId), JsonConvert.SerializeObject(properties));
        }
        ...
        {
            await client.HttpClient.PatchAsync(string.Format("/channels/{0}/messages/{1}", channelId, messageId), JsonConvert.SerializeObject(properties));
        }
        ...
        {
            await client.HttpClient.PatchAsync(string.Format("/channels/{0}/messages/{1}", channelId, messageId), JsonConvert.SerializeObject(new
            {
                content = message,
                tts = tts
            }));
        ...
        {
            await client.HttpClient.DeleteAsync(string.Format("/channels/{0}/messages/{1}", channelId, messageId));
        }
